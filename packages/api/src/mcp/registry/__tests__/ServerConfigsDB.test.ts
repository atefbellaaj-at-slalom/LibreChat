...
beforeAll(async () => {
  ...
  jest.spyOn(dataSchemas.logger, 'error').mockImplementation((() => dataSchemas.logger) as never);
  jest.spyOn(dataSchemas.logger, 'warn').mockImplementation((() => dataSchemas.logger) as never);
  jest.spyOn(dataSchemas.logger, 'debug').mockImplementation((() => dataSchemas.logger) as never);
  jest.spyOn(dataSchemas.logger, 'info').mockImplementation((() => dataSchemas.logger) as never);
